...
Run wget -c -v https://github.com/gohugoio/hugo/releases/download/v0.75.1/hugo_extended_0.75.1_Linux-64bit.deb \
    && sudo apt install ./hugo_extended_0.75.1_Linux-64bit.deb \
    && rm hugo_extended_0.75.1_Linux-64bit.deb
